      ...
      <div id="diplayButton">
        ...
        <div v-if="imgUserInput.legale != '' && imgUserInput.legale != undefined">
          <div :class="[showTypingIndicator ? 'cacheButtom' : ''] " >
            <button @click.prevent="clickButton('!legale', !(showTypingIndicator), false)" class="sc-user-input--button-icon-wrapper" id="extraCarrousel" >
        ...
        <div v-if="imgUserInput.contenuSpecial1 != '' && imgUserInput.contenuSpecial1 != undefined">
          <div :class="[showTypingIndicator || menuNotPass() || beginNotPass() ? 'cacheButtom' : '']">
            <button @click="clickButton('!contenuSpecial1', !(showTypingIndicator || menuNotPass() || beginNotPass()), false)" class="sc-user-input--button-icon-wrapper" id="extraCarrousel" >
        ...
        <div v-if="imgUserInput.contenuSpecial2 != '' && imgUserInput.contenuSpecial2 != undefined">
          <div :class="[showTypingIndicator || menuNotPass() || beginNotPass() ? 'cacheButtom' : '']">
            <button @click="clickButton('!contenuSpecial2', !(showTypingIndicator || menuNotPass() || beginNotPass()), false)" class="sc-user-input--button-icon-wrapper" id="extraCarrousel" >
        ...
        <div v-if="imgUserInput.contenuSpecial3 != '' && imgUserInput.contenuSpecial3 != undefined">
          <div :class="[showTypingIndicator || menuNotPass() || beginNotPass() ? 'cacheButtom' : '']">
            <button @click="clickButton('!contenuSpecial3', !(showTypingIndicator || menuNotPass() || beginNotPass()), false)" class="sc-user-input--button-icon-wrapper" id="extraCarrousel" >
        ...
        <div v-if="imgUserInput.carte != '' && imgUserInput.carte != undefined">
          <div :class="[!(mapSetting.exist && calculNbRepBeforeFct() && !showTypingIndicator) ? 'cacheButtom' : '']">
            <button @click="clickButton('!map', (mapSetting.exist && calculNbRepBeforeFct() && !showTypingIndicator), false)" class="sc-user-input--button-icon-wrapper" id="showMap" tooltip="Map">
