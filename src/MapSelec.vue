<template>
  <div>
    <div id="cadreForMapMenu" ref="cadreForMapMenu" @mousedown="initialClick" @mouseup="initialClick" @mousemove="move" @touchstart="initialClickTel" @touchmove.passive="moveTel">
  ...
  methods: {
    ...
    initialClick(e) {
      ...
      if (window.innerWidth > 450) {
        ...
        document.addEventListener("mousemove", move, false, this.sensibilitClicPosi);
